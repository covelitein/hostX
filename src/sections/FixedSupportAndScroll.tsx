...
const FixedSupportAndScroll = () => {
  ...
  return (
    <div className="fixed bg-white py-2 w-[4rem] bottom-4 left-3 border-gray-400 border-[1px] rounded-xl flex flex-col items-center justify-between p-4 shadow-lg space-y-6">
      {/* Support Icon */}
      <motion.div
