...
const FixedSupportAndScroll = () => {
  ...
  return (
    <div className="fixed bg-white py-2 w-[4rem] z-[999] bottom-4 right-3 border-gray-400 border-[1px] rounded-xl flex flex-col items-center justify-between p-4 shadow-lg space-y-6">
      {/* Support Icon */}
      <motion.div
